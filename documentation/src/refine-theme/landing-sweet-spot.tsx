...
const list = [
    {
        title: "Nginx or Apache web servers",
        description: `For each user you can choose Nginx or Apache web servers. *LiteSpeed will also be added in future.`,
    ...
    },
    {
        ...
        icon: (props: { active: boolean }) => (
            <svg fill="#777bb4" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24">
                <path
    ...
    {
        title: "ModSecurity WAF & Uncomplicated Firewall",
        ...
        icon: (props: { active: boolean }) => (
            ...
            <polygon style="fill:#FFCE54;" points="447.649,238.094 447.649,152.817 319.764,152.817 298.437,152.817 170.545,152.817 
                170.545,238.094 106.594,238.094 106.594,344.667 144.799,344.667 144.799,429.929 298.437,429.929 319.764,429.929 
                447.649,429.929 447.649,344.667 511.598,344.667 511.598,238.094 "/>
            <path style="fill:#F6BB42;" d="M511.598,238.094h-63.949v-85.277H319.764h-21.327H170.545v85.277h-63.95v106.573h38.204v85.262
                h153.638h21.327h127.885v-85.262h63.949V238.094z M319.764,174.144h106.572v63.95h-42.623h-21.326h-42.623L319.764,174.144
                L319.764,174.144z M362.387,323.356h-42.623h-21.327h-42.63v-63.95h42.63h21.327h42.623V323.356z M191.856,174.144h106.581v63.95
                h-42.63h-21.312h-42.639V174.144z M127.906,323.356v-63.95h42.639h63.95v63.95h-89.696H127.906z M298.437,408.617H166.126v-63.95
                h68.369h21.312h42.63V408.617z M426.336,408.617H319.764v-63.95h42.623h21.326h42.623V408.617z M490.287,323.356h-42.638h-63.936
                v-63.95h63.936h42.639v63.95H490.287z"/>
            <g>
                <path style="fill:#FC6E51;" d="M145.83,429.788C144.799,429.788,146.844,429.82,145.83,429.788L145.83,429.788z"/>
                <path style="fill:#FC6E51;" d="M221.848,224.995c-52.147-62.171-31.694-143.326-31.694-143.326
                    C101.63,98.344,55.713,155.174,43.753,242.575c-9.571-6.588-23.232-8.759-30.429-17.72
                    C-36.45,354.113,63.347,433.426,145.83,429.789C227.968,426.166,318.592,340.326,221.848,224.995z"/>
            </g>
            </svg>
        ),
        iconText: "Firewall",
